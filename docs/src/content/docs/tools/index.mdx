---
title: All Tools
description: 13 MCP tools for ticket lifecycle, discovery, and collaboration. Filter, search, and inspect every parameter.
---

import ToolExplorer from '../../../islands/ToolExplorer.tsx';
import '../../../styles/explorer.css';

13 tools, three categories. Filter by category, search by keyword, click any card to expand its full schema.
